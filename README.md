...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-violet-b38c
```

A live public deployment of this template is available at [https://aged-violet-b38c.templates.workers.dev](https://aged-violet-b38c.templates.workers.dev)
